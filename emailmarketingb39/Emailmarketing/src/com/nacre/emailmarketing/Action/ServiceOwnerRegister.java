...
@WebServlet("/ServiceOwnerRegister")
public class ServiceOwnerRegister extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ServiceOwnerServiceI serviceOwnerServiceI=null;
		try {
			...
			//create Service Obj
			serviceOwnerServiceI=new ServiceOwnerServiceImpl();
				if(serviceOwnerServiceI.registerServiceOwnerDetails(registerDto)){
