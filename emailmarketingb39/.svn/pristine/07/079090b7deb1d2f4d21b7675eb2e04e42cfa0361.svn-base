	...
	<div class="main-container">
		<div class="main-content">
			<div class="row">
					...
					<div class="login-container">
						<div class="center">
							...
							<!-- 	<i class="ace-icon fa fa-leaf green"></i>  -->
								<span class="blue">Place your order</span>
							</h2>
						</div>
						...
						<div class="position-relative" style="width: 130%">
							...
							<div id="login-box"
										...
										<div class="hero-unit">
											...
											<form  id='reg-form'
												...
												<input type="hidden" name="identity" value="1">
													<input type="hidden" id="url" value="<%=application.getContextPath() %>/UserRegister">
												...
												required="required"		name="email" id="email"/> <i class="ace-icon fa fa-envelope"></i>
														...
														<!-- <div class="form-group">
														<label class="block clearfix"> <span
															class="block input-icon input-icon-right"> <b>CompanyName:<span style="color:red;">*</span><span id="lname-msg"></b><input
																type="text" class="form-control" placeholder="EX-Samsung"
																name="cname" id="cname"/> <lable id="CompanyName1"/></lable><i class="ace-icon fa fa-user"></i>
														</span>
							 ...
							 -->
														...
														class='form-control'	placeholder="EX-Ameerpet" name="location" id="location"
															required="required"> 
														</span>
														</label>
														</div>
        		...
        		&nbsp;&nbsp;&nbsp;&nbsp;<a class="accordion-section-title"  href="#accordion-1"><button type="submit" class="width-25 pull-right btn btn-sm btn-primary">
															<span>CONTINUE</span></button></div>
</a> 
        		<div id="accordion-1" class="accordion-section-content" style="display:none">
            	<div class="form-group">
                      <label class="block clearfix"> <span class="block input-icon input-icon-right"> <b>Account Number:<span style="color:red;">*</span></b>
                      <input type="text" class='form-control'	name="ac" id="ac" required="required"></select>
														</span>
														</label>

														</div>	
				<div class="form-group">
                      <label class="block clearfix"> <span class="block input-icon input-icon-right"> <b>AccountHolder Name :<span style="color:red;">*</span></b>
                      <input type="text" class='form-control'	name="ac1" id="ac1" required="required"></select>
														</span>
														</label>

														</div>	
				<div class="form-group">
                      <label class="block clearfix"> <span class="block input-icon input-icon-right"> <b>Pin :<span style="color:red;">*</span></b>
                      <input type="password" class='form-control'	name="ac2" id="ac2" required="required"></select>
														</span>
														</label>

														</div>	
				   			  
   			  <button type="submit" class="width-25 pull-right btn btn-sm btn-primary" id="submit">
															<span id="submit">BUY</span></button>
...
<!-- 															<i class="ace-icon fa fa-arrow-right icon-on-right"></i>
 -->														</button>
												...
												<div style="text-align:center; color:red" id="error">Internal Problem</div>
												<div style="text-align:center; color:green" id="success1">Out of Stock</div>
												<div style="text-align:center; color:green" id="success">Order place successfully</div>
			...
			.formValidation({
			    ...
			    fields: {
			        ...
			        cname: {
			            ...
			            validators: {
			                notEmpty: {
			                    message: 'The Company Name Name is required and can\'t be empty'
			                },
			                stringLength: {
			                    min: 2,
			                    max: 30,
